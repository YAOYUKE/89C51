...
void Show_1616(u8 line,u8 columm,u8 *address);         // 显示一个16*16汉字
void Show_2424(u8 line,u8 columm,u8 *address);         // 显示一个24*24汉字
void Show_1608(u8 line,u8 columm,u8 *address);         // 显示一个16*08字母
